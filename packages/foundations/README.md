# @mszczygiel-projects/foundations
...
```ts
import { tokens } from '@mszczygiel-projects/foundations';
import type { TokenKey } from '@mszczygiel-projects/foundations';
...
```bash
pnpm --filter @mszczygiel-projects/foundations run build
```
...
```bash
pnpm --filter @mszczygiel-projects/foundations run test
```
