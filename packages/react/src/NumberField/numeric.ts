/**
 * Numeric helpers shared by the NumberField internals.
 *
 * Kept separate from the component so the arithmetic — the part with the
 * floating-point traps — can be tested without rendering anything.
 */
