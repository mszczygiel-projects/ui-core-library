...
describe('UiLinkButton', () => {
  it('renders inner <a> element', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="/page">Click</ui-link-button>`);
  ...
  it('does not set disabled HTML attribute on <a>', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="/page" disabled>Click</ui-link-button>`);
    expect(el.shadowRoot!.querySelector('a')!.hasAttribute('disabled')).to.equal(false);
  });

  it('reflects variant attribute', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="/page" variant="secondary">Click</ui-link-button>`);
  ...
  it('loading sets aria-disabled, aria-busy and tabindex on inner <a>', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="/page" loading>Click</ui-link-button>`);
    const a = el.shadowRoot!.querySelector('a')!;
    expect(a.getAttribute('aria-disabled')).to.equal('true');
  ...
  it('label prop sets aria-label on inner <a>', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="/page" label="Go to page">Click</ui-link-button>`);
  ...
  it('target="_blank" without rel sets noopener noreferrer', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="https://example.com" target="_blank">Click</ui-link-button>`);
  ...
  it('target="_blank" with explicit rel uses provided rel', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="https://example.com" target="_blank" rel="noopener">Click</ui-link-button>`);
  ...
  it('default slot projects label text', async () => {
    const el = await fixture<UiLinkButton>(html`<ui-link-button href="/page">Go to dashboard</ui-link-button>`);
