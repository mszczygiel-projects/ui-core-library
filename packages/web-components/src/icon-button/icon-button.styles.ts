...
export const iconButtonStyles = css`
  ...
  :host([data-size='small']) {
    ...
    --_icon-size: var(--button-small-icon-size);
  }

  :host([data-size='large']) {
    border-radius: var(--button-large-radius);
    --_icon-size: var(--button-large-icon-size);
  }
  ...
  button {
    ...
    padding: var(--button-padding-stack);
  ...
  :host([data-size='small']) button {
    padding: var(--button-small-padding-stack);
    border-radius: var(--button-small-radius);
  }

  :host([data-size='large']) button {
    padding: var(--button-large-padding-stack);
    border-radius: var(--button-large-radius);
  }
