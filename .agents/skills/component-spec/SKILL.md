...
- Package scope: `@mszczygiel-projects/ui-core-wc` + `@mszczygiel-projects/ui-core-react` (always both unless stated otherwise)
...
Default export uses `@mszczygiel-projects/ui-core-foundations/base.css` + story-level decorator if needed.
